...
public class SampleGeneratorToolTests
{
    ...
    public void Setup()
    {
        ...
        _languageServices = [
            ...
            new JavaLanguageService(_mockProcessHelper.Object, new Mock<IMavenHelper>().Object, realGitHelper, microagentHostServiceMock.Object, languageLogger, _commonValidationHelpers.Object),
